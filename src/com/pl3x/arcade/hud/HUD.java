...
public class HUD {
	...
	public static boolean isInfoShowed = false;
	...
	public void tick(){
		...
		//HEALTH--; //always drown the health (DEBUG USE ONLY)
		//HEALTH2--; //always drown the health (DEBUG USE ONLY)
	...
	public void render(Graphics g, Handler handler){ //some stuff for the hud
